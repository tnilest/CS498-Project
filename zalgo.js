...
//
//input.onkeyup = change_btn.onclick = function(){
//    out.innerHTML = Z.generate(input.value);
//};

function change(words) {
    return Z.generate(words)
    //document.getElementById("test").innerHTML = Z.generate(words)
}
